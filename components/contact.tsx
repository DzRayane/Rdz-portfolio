      ...
      <div className="relative mx-auto max-w-2xl text-center">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <a
            ...
            className="inline-flex items-center gap-3 rounded-xl px-6 py-3.5 text-sm text-muted-foreground transition-all hover:text-primary hover:border-primary/30"
          ...
          <div
            className="inline-flex items-center gap-3 rounded-xl px-6 py-3.5 text-sm text-muted-foreground"
            style={{ background: 'rgba(0,229,255,0.04)', border: '1px solid rgba(0,229,255,0.1)' }}
          >
