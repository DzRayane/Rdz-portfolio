  ...
  return (
    <section id="contact" className="relative py-28 px-6">
      ...
      <div className="relative mx-auto max-w-2xl text-center">
        ...
        <div className="mb-12 inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-medium text-primary neon-glow" style={{ background: 'rgba(0,229,255,0.06)', border: '1px solid rgba(0,229,255,0.2)' }}>
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          ...
          <a
            href="https://linkedin.com/in/rayane-dziri"
            target="_blank"
